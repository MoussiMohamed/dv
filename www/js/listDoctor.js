	...
	$.ajax({    //create an ajax request to load_page.php
        ...
        success: function(response){                    
		    ...
		    response.d[i].id_medecin,			
                    ...
                    '<input type="button"  class="btn btn-primary" value = "Modifier" onClick="Javascript:changeScreanToEdit(this)" >',
                    '<input type="button" class="btn btn-danger" value = "Supprimer" data-title="Delete" data-toggle="modal" onClick="Javascript:getIdDoctor(this)" data-target="#delete" >'
                ] ).draw();
