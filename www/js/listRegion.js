	...
	$.ajax({    //create an ajax request to load_page.php
        ...
        success: function(response){                    
		    ...
		    response.d[i].id_region,			
                ...
                '<input type="button" class="btn btn-danger" value = "Supprimer" data-title="Delete" data-toggle="modal" onClick="Javascript:getIdRegion(this)" data-target="#delete" >',
		'<input type="button" class="btn btn-primary" value = "Affecter" data-title="Affecter" data-toggle="modal" onClick="Javascript:getIdRegion(this)" >'
                ] ).draw();
